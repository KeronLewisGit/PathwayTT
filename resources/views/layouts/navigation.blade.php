<nav x-data="{ open: false }" class="bg-brand-800 text-white shadow-md">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden lg:flex lg:items-center lg:ms-6">
                @if (Auth::user()->is_admin)
                    <a href="/admin" class="me-4 text-sm text-brand-100 hover:text-white">Admin</a>
                @endif
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-brand-100 hover:text-white focus:outline-none transition ease-in-out duration-150">
            ...
            <div class="-me-2 flex items-center lg:hidden">
                <button @click="open = ! open" aria-label="Toggle navigation" class="inline-flex items-center justify-center p-2 rounded-md text-brand-100 hover:text-white hover:bg-brand-700 focus:outline-none focus:bg-brand-700 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden lg:hidden border-t border-brand-700">
