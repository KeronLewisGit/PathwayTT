    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <a href="{{ route('resume.index') }}" class="block card p-5 hover:shadow">
                ...
                <a href="{{ route('profile.review') }}" class="block card p-5 hover:shadow">
                ...
                <a href="{{ route('preferences.index') }}" class="block card p-5 hover:shadow">
                ...
                <a href="{{ route('matches.index') }}" class="block card p-5 hover:shadow">
